...
public class Printer {
    ...
    private boolean snmpReachable = true;
    ...
    public boolean isSnmpReachable() {return snmpReachable;}

    public void setSnmpReachable(boolean snmpReachable) {this.snmpReachable = snmpReachable;}
