...
public class SnmpService {
    ...
    // status OID
    private static final OID PRINTER_STATUS_OID = new OID("1.3.6.1.2.1.25.3.5.1.1");
    ...
    private String getSnmpValue(String ipAddress, OID oid) {
        ...
        try {
            ...
            Address targetAddress = GenericAddress.parse("udp:" + ipAddress + "/1000");
    ...
    public String getStatus(String ipAddress) {
        String statusValue = getSnmpValue(ipAddress, PRINTER_STATUS_OID);
        if (statusValue != null && !statusValue.isEmpty()) {
            try {
                ...
                System.err.println("ERROR: Could not parse printer status '" + statusValue + "' for " + ipAddress + ". " + e.getMessage());
                return "Unknown";
            }
        }
        return "Unknown";
